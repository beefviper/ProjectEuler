...
uint64_t problem11()
{
	...
	for (int x = 0; x < 20 - 4 + 1; x++) {
		for (int y = 0; y < 20 - 4 + 1; y++) {
			for (int i = 0; i < 4; i++) {
				product.push_back(data[x + i][y + 0] * data[x + i][y + 1]
					* data[x + i][y + 2] * data[x + i][y + 3]);
				product.push_back(data[x + 0][y + i] * data[x + 1][y + i]
					* data[x + 2][y + i] * data[x + 3][y + i]);
			}

			product.push_back(data[x + 0][y + 0] * data[x + 1][y + 1]
				* data[x + 2][y + 2] * data[x + 3][y + 3]);
			product.push_back(data[x + 0][y + 3] * data[x + 1][y + 2]
				* data[x + 2][y + 1] * data[x + 3][y + 0]);
		}
	}
